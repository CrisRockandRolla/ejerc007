...
public class DatosTest {
    ...
    public static final String CONTENIDO_CINE = "CINE_1\t\tSALA_1\t\tSESION_1: 17:00, Film1\t\t Entradas disponibles: 100\n" +
    ...
    public static final String CONTENIDO_SALA_1 = "CINE_1\t\tSALA_1\t\tSESION_1: 17:00, Film1\t\t Entradas disponibles: 100\n" +
            "CINE_1\t\tSALA_1\t\tSESION_2: 20:00, Film1\t\t Entradas disponibles: 100\n" +
            "CINE_1\t\tSALA_1\t\tSESION_3: 22:30, Film2\t\t Entradas disponibles: 100\n" +
            "\n" +
            "{Total descuentos=0.0, Total Recaudado=0.0, Aforo total=300, Ocupacion=0.0, Entradas vendidas=0}\n";

    public static final String CONTENIDO_VER_SESION = "CINE_1\t\tSALA_3\t\tSESION_7: 17:00, Film5\t\t Entradas disponibles: 20\n" +
            "\n" + "{Total descuentos=0.0, Total Recaudado=0.0, Aforo total=20, Ocupacion=0.0, Entradas vendidas=0}\n";

    public static final String RESPUESTA_VER_CREAR = "Venta Nº VENTA_1\tSESION_2\n" +
            "\tEntradas 50\tPrecio 5.0\ttotal 250.0\tDescuento 25.0\ttotalPagar 225.0\n" +
            "\tVenta cancelada false\t\tEntradas Canceladas 0" + "\n";

    public static final String RESPUESTA_MODIFICAR_ENTRADAS_SESION = "Venta Nº VENTA_1\tSESION_7\n" +
            "\tEntradas 2\tPrecio 5.0\ttotal 10.0\tDescuento 0.0\ttotalPagar 10.0\n" +
            "\tVenta cancelada false\t\tEntradas Canceladas 0" + "\n";

    public static final String RESPUESTA_MODIFICAR_SESION = "Venta Nº VENTA_1\tSESION_7\n" +
            "\tEntradas 4\tPrecio 5.0\ttotal 20.0\tDescuento 0.0\ttotalPagar 20.0\n" +
            "\tVenta cancelada false\t\tEntradas Canceladas 0" + "\n";

    public static final String RESPUESTA_MODIFICAR_ENTRADAS = "Venta Nº VENTA_1\tSESION_2\n" +
            "\tEntradas 48\tPrecio 5.0\ttotal 240.0\tDescuento 24.0\ttotalPagar 216.0\n" +
            "\tVenta cancelada false\t\tEntradas Canceladas 2" + "\n";

    public static final String CONTENIDO_ESTADISTICAS = "CINE_1\t{Total descuentos=0.0, Total Recaudado=0.0, Aforo total=510, Ocupacion=0.0, Entradas vendidas=0}\n" +
